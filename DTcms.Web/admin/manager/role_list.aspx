...
<ItemTemplate>
  <tr>
    ...
    <td>
        ...
        <a href="role_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("role_name")%></a>
    </td>
    <td><%#GetTypeName( Convert.ToInt32(Eval("role_type")))%></td>
    <td><%#GetIdentifyName(Convert.ToInt32(Eval("identify"))) %></td>
