...
namespace DTcms.DAL
{
    ...
    public partial class manager
    {
        ...
        public int Add(Model.manager model)
        {
            ...
            strSql.Append("role_id,role_type,user_name,password,salt,real_name,telephone,email,is_lock,add_time,job,ad_id,identify)");
            ...
            parameters[11].Value = model.adID;
            parameters[12].Value = model.identify;
        ...
        public bool UpdateByAdID(Model.manager model)
        {
            ...
            parameters[10].Value = model.identify;
            parameters[11].Value = model.adID;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,role_id,role_type,user_name,password,salt,real_name,telephone,email,is_lock,add_time,job,ad_id,identify from " + databaseprefix + "manager ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,role_id,role_type,user_name,password,salt,real_name,telephone,email,is_lock,add_time,job,ad_id,identify ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,role_id,role_type,user_name,password,salt,real_name,telephone,email,is_lock,add_time,job,ad_id,identify ");
            strSql.Append(" FROM " + databaseprefix + "manager ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
