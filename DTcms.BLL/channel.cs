...
namespace DTcms.BLL
{
    ...
    public partial class channel
    {
        ...
        public int Add(Model.channel model)
        {
            ...
            {
                //添加导航菜单
                int newNavId = new BLL.navigation().Add("channel_" + build_path, "channel_" + model.name, model.title, "", model.sort_id, channelId, "Show,Audit,Ban");
                if (newNavId < 1)
                {
                ...
                //添加子导航菜单
                new BLL.navigation().Add("channel_" + model.name, "channel_" + model.name + "_list", "内容管理", "article/article_list.aspx", 99, channelId, "Show,View,Add,Edit,Delete");
